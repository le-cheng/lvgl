...
#if defined(CONFIG_ASR_DPU_DISPLAY_V3) && !defined(CONFIG_LV_USE_NUTTX_LCD)
...
#if defined(CONFIG_ASR_DPU_DISPLAY_V3) && !defined(CONFIG_LV_USE_NUTTX_LCD)
static int fbdev_enable(lv_nuttx_fb_t * dsc);
static void fbdev_disable(lv_nuttx_fb_t * dsc);
#endif
