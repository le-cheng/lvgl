...
#else
    lv_draw_buf_t * mask_hour = lv_draw_buf_create(MASK_WIDTH, MASK_HEIGHT, LV_COLOR_FORMAT_A8, 0);
    generate_mask(mask_hour, MASK_WIDTH, MASK_HEIGHT, "23");
#endif
...
#else
    lv_draw_buf_t * mask_minute = lv_draw_buf_create(MASK_WIDTH, MASK_HEIGHT, LV_COLOR_FORMAT_A8, 0);
    generate_mask(mask_minute, MASK_WIDTH, MASK_HEIGHT, "17");
#endif
